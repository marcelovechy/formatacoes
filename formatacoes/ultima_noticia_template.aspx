<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ultima_noticia_template.aspx.cs" Inherits="formatacoes.ultima_noticia_template" %>
...
<body>
    ...
    <!-- Top Header Start -->
        ...
        <asp:Xml ID="xml1" runat="server" TransformSource="~/formata_noticia_template.xslt"></asp:Xml>
